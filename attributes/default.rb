...
default['openstack']['object-storage']['sysctl']['net.ipv4.tcp_tw_recycle'] = 1
default['openstack']['object-storage']['sysctl']['net.ipv4.tcp_tw_reuse'] = 1
default['openstack']['object-storage']['sysctl']['net.ipv4.tcp_syncookies'] = 0

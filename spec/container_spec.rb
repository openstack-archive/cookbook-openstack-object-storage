  ...
  describe 'ubuntu' do
    ...
    describe '/etc/swift/container-server.conf' do
      ...
      describe 'default attribute values' do
        it_behaves_like 'a common swift server default attribute values checker', 'container', '6001'
      ...
      describe 'template contents' do
        it_behaves_like 'a common swift server configurator', 'container', '6001'
